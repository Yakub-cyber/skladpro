...
// — в operations/_shared.jsx. Порядок вкладок и метки — как в CloudShop.
// «Продажа» = документ (для опта, с клиентом/скидкой/долгом), розница
// пробивается через кассу (/orders/new).
